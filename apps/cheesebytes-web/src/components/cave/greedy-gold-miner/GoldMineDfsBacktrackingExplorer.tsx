...
export interface GoldMineDfsBacktrackingExplorerProps {
  maxWidth?: number;
}

export const GoldMineDfsBacktrackingExplorer: React.FC<
  GoldMineDfsBacktrackingExplorerProps
> = ({ maxWidth = 980 }) => (
  <GoldMineReplayExplorer
    maxWidth={maxWidth}
    title="DFS with backtracking"
    vimModeId="gold-mine-dfs-backtracking"
    vimModeLabel="DFS+BT"
